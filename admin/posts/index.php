    ...
    <div class="admin-wraper min-h-full">
        ...
        <div class="admin-content h-full pt-10 px-24 pb-24 overflow-y-scroll">
            <div class="button-group mb-4">
                <a href="create.php" class="btn py-[.5rem] px-[1rem] text-fuchsia-800 hover:bg-fuchsia-800 hover:text-white duration-1000  bottom-[10px] right-[10px] read-more bg-transparent">Add Post</a>
                <a href="index.php" class="btn py-[.5rem] px-[1rem] text-fuchsia-800 hover:bg-fuchsia-800 hover:text-white duration-1000  bottom-[10px] right-[10px] read-more bg-transparent">Manage Posts</a>
            </div>
                ...
                <table class="w-full border-collapse ">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="#" class="publish text-blue-500 hover:underline">publish</a></td>
                        </tr>
